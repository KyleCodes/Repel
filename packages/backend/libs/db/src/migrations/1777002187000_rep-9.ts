...
import { AuthMethod, Channel, Provider } from '@repel/enums';

// v0 schema. Enum values are sourced from @repel/enums so the Postgres enum
...
export async function up(pgm: MigrationBuilder): Promise<void> {
  // Enums — single source of truth lives in @repel/enums.
